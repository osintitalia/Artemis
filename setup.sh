...
echo "    "
echo -e "$RESET"
echo -e "$OKRED                              +----=[Osint Italia]=----+ $RESET"
...
mkdir ~/Documents/scripts && cp ~/Downloads/Artemis/scripts/* ~/Documents/scripts
sudo chmod +x ~/Documents/scripts/*.sh

mkdir ~/Pictures/icons && cp ~/Downloads/Artemis/multimedia/icons/* ~/Pictures/icons

sudo cp ~/Downloads/Artemis/shortcuts/* /usr/share/applications/
...
cp -r ~/Downloads/Artemis/templates/* ~/Templates

# setting the 'quiet priest' background image
cp ~/Downloads/Artemis/multimedia/wallpapers/* ~/Pictures && ~/Documents/scripts/background.sh
echo -e "$OKGREEN +----=[DOOONE!!!]=----+ $RESET"
echo "    "
...
cd ~/Downloads/Artemis/ffprofile/
zip -F ffprofile.zip --out Artemis-ff-template2.zip
unzip Artemis-ff-template2.zip
cp -R ~/Downloads/Artemis/ffprofile/Artemis-ff-template/* ~/snap/firefox/common/.mozilla/firefox/*.default
echo -e "$OKGREEN +----=[DOOONE!!!]=----+ $RESET"
echo "    "
